    ...
    <div className="grid md:grid-cols-2 gap-0 items-center">
      ...
      <div className="p-12 md:p-16 order-2 md:order-1 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          {/* Título principal - Todos en blanco */}
          <h2 className="text-6xl md:text-7xl font-black tracking-tighter leading-none drop-shadow-2xl text-white">
            {slide.title}
          </h2>
          
          {/* Subtítulo - Todos en blanco */}
          <h3 className="text-4xl md:text-5xl font-bold drop-shadow-lg text-white">
            {slide.subtitle}
          </h3>
          
          {/* Descripción - Todos en blanco */}
          <p className="text-xl md:text-2xl max-w-2xl leading-relaxed font-medium drop-shadow-lg text-white">
            {slide.description}
          </p>
          
          {/* Ingredientes - Todos en negro */}
          <div className="bg-gradient-to-r from-orange-100 via-yellow-50 to-orange-100 dark:from-orange-900/30 dark:via-yellow-900/20 dark:to-orange-900/30 p-6 rounded-2xl shadow-xl border-2 border-orange-300 dark:border-orange-700 w-full max-w-lg">
            <ul className="text-lg font-semibold leading-relaxed space-y-2 text-black">
