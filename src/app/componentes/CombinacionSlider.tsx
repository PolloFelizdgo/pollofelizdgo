    ...
    <div className="grid md:grid-cols-2 gap-0 items-center">
      ...
      <div className="p-12 md:p-16 order-2 md:order-1 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          {/* Título principal - Blanco para Ensalada Caesar y Hamburguesa, negro para los demás */}
          ...
          {/* Subtítulo - Blanco para Ensalada Caesar y Hamburguesa, negro para los demás */}
